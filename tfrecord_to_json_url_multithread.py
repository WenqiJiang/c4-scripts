# Example Usage: 
#   python3 tfrecord_to_json_url_multithread.py --dir_in 'gs://c4multilingual201918/tensorflow_datasets/c4/multilingual201918nodedup/3.0.1/' --dir_out 'gs://c4multilingual201918/tensorflow_datasets/c4_json_url/multilingual201918nodedup/3.0.1/'
...
parser.add_argument('--dir_in', type=str, default='gs://c4multilingual201918/tensorflow_datasets/c4/multilingual201918nodedup/3.0.1/', help="google storage input directory (tf record)")
parser.add_argument('--dir_out', type=str, default='gs://c4multilingual201918/tensorflow_datasets/c4_json_url/multilingual201918nodedup/3.0.1/', help="google storage output directory (json)")
...
def tfrecord_to_json(args):
    ...
    for raw_record in raw_dataset:
        ...
        json_string = json.dumps({
            ...
            'url': record['url'].numpy().decode("utf-8"), 
            #'timestamp': record['timestamp'].numpy().decode("utf-8"),
            })
