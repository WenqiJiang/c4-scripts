...
with open(file_path_in_list_path, 'w') as f:
    ...
    for i in range(2048):
        lines.append(parent_url + 'c4-en.tfrecord-{}-of-01024.json'.format(str(i).zfill(5)) + '\n' )
    ...
    for i in range(32):
        lines.append(parent_url + 'c4-ja.tfrecord-{}-of-01024.json'.format(str(i).zfill(5)) + '\n' )

    for i in range(4):
        lines.append(parent_url + 'c4-zh.tfrecord-{}-of-01024.json'.format(str(i).zfill(5)) + '\n' )
