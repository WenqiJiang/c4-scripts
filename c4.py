...
# Wenqi: as of Jan 2022
LATER_CC_VERSIONS = ( 
        "2020-40", "2020-45", "2020-50", "2021-04", "2021-10", "2021-17", "2021-21",
        "2021-25", "2021-31", "2021-39", "2021-43", "2021-49", "2022-05")

# Wenqi: original ones that does not work
# MS1B2019_CC_VERSIONS = ('2019-04', '2019-09', '2019-13', '2019-18')
# Wenqi: now try the OPENWEBTEXT ONES
MS1B2019_CC_VERSIONS = (
    "2019-18",  # Original default for single-crawl dataset (April 2019).
    "2019-30",
    "2019-26")
...
TOP5_LANGUAGES = ["en", "ru", "de", "zh", "ja"]
TOP10_LANGUAGES = ["en", "ru", "de", "zh", "ja", "fr", "es", "it", "pt", "nl"]
...
class C4(tfds.core.BeamBasedBuilder):
  ...
  # beam: the name must consist of only the characters [-a-z0-9], starting with a letter and ending with a letter or number
  BUILDER_CONFIGS = [
      C4Config(
          "en",
          languages=["en"],
      ...
      C4Config(
          ...
          paragraph_filter=False,
          dedupe=False,
          description="English C4 dataset (for web encoding)."),
      C4Config(
          "enweb201930",
          languages=["en"],
          cc_versions=('2019-30',),
      ...
      C4Config(
          ...
          dedupe=True,
          badwords_filter=True,
          description="English C4 dataset (2013 version)."),
      # en202205 does not work, a lot of HTTP 503 errors
      C4Config(
          "en202205",
          languages=["en"],
          cc_versions=('2022-05',),
      ...
      C4Config(
          ...
          "etc.)"),
      # ms1bclean does not work, a lot of HTTP 503 errors, from all 4 dumps
      C4Config(
          "ms1bclean",
          languages=["en"],
          cc_versions=('2022-05', '2021-49', '2021-43', '2021-39',),
          clean=True,
          badwords_filter=True,
          paragraph_filter=True,
          dedupe=True,
          description="The 1B clean dataset used for ML training"),
      C4Config(
          "ms1bclean2019",
          languages=["en"],
          cc_versions=MS1B2019_CC_VERSIONS,
          clean=True,
          badwords_filter=True,
          # paragraph_filter=False,
          dedupe=True,
          description="The 1B clean dataset used for ML training, use several dumps in 2019"),
      C4Config(
          "ms1bnodedup2019",
          languages=["en"],
          cc_versions=MS1B2019_CC_VERSIONS,
          ...
          paragraph_filter=False,
          dedupe=False,
          description="The 1B clean + no dedup dataset used for ML training, use several dumps in 2019"),
      C4Config(
          "multilingual201918nodedup",
          ...
          dedupe=False,
          badwords_filter=True,
          description="Multilingual C4 (mC4) has 101 languages and is generated from 1 "
          "Common Crawl dumps."),
      C4Config(
          "multilingual",
