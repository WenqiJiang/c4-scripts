...
Example:
  python json_to_passages_multithread.py --file_path_in_list_path ./json_input_file_list --file_path_out_list_path passage_output_file_list --skip_exist 1
"""
...
GEN_PASSAGE = True
GEN_SENTENCE = False
assert GEN_PASSAGE != GEN_SENTENCE, "either generate passages or sentences"
if GEN_SENTENCE:
...
if __name__ == '__main__':
    ...
    with multiprocessing.Pool(processes=max_threads) as pool:
        pool.map(devide_pages, arg_list)
